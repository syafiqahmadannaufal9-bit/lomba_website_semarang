      ...
      <main className="hero">
        <div className="hero-content">
          ...
          <div className="hero-center">
            <img 
              src="/assets/Tugumuda.png" 
              alt="Tugu Muda Semarang" 
        ...
        {/* Navigation Arrows */}
        <button className="arrow-btn arrow-left" aria-label="Previous">
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
            <path d="M15 18L9 12L15 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <button className="arrow-btn arrow-right" aria-label="Next">
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
